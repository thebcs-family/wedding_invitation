      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div ref={koreaRef} className="location-box flex-1">
          <div className="h-64 overflow-hidden relative">
            <Image src="/images/optimized/korea.jpg" alt="Korea" width={400} height={256} className="w-full h-full object-cover object-center" />
        ...
        <div ref={boliviaRef} className="location-box flex-1">
          <div className="h-64 overflow-hidden relative">
            <Image src="/images/optimized/bolivia.jpg" alt="Bolivia" width={400} height={256} className="w-full h-full object-cover object-center" />
        ...
        <div ref={italyRef} className="location-box flex-1">
          <div className="h-64 overflow-hidden relative">
            <Image src="/images/optimized/italy.jpg" alt="Italy" width={400} height={256} className="w-full h-full object-cover object-center scale-150" />
            <div className="location-date">Coming Soon</div>
          </div>
          <div className="location-content p-6">
